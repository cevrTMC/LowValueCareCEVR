...
SAS code: **03_split_combine.sas**

Each patient_id is mapped to a id_group based on last two digits of id. Split each flag file by id_group, then combine flag files that belong to the same id_group.
