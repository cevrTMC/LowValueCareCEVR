...
Each claim-base file will be divided into many smaller chunk files, each containing approximately 1,000,000 claims. The corresponding line/revenue file is also divided into smaller chunk files containing the same claim No. as in the corresponding claim basic chunk file.
