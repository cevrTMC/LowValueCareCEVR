...
### 1. Split large claim files by claims
...
As shown in the table below, after this step of processing, there will
be approximately 150 output files, including 48(4 years\*12 chunks)
inpatient flag files, 48(4 year\*12 chunks) outpatient flag files, and
48 (4 year\*12 chunks) carrier flag files.
...
### 4. Split-Merge flag files by bene\_id
